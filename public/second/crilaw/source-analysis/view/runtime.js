...
function e(e, t, n) {
    ...
    "function" == typeof a
        ? (a = new a(t, { detail: n }))
        : ((a = r.createEvent("Event")).initEvent(t, !1, !1), (a.detail = n)),
        e.dispatchEvent(a);
}
function t(e) {
    return (
...
function h(e) {
    try {
        ...
        const n = t.find((e) => !e.modifier),
            ...
            o = t.some((e) => e.setish);
        return { name: `${r ? r.name : ""}${n.name}`, symbols: t, arrayish: a && !o, setish: o };
    } catch (e) {
        return null;
    }
}
...
class Inspector {
    ...
    rejected(t, n) {
        const { _node: a } = this;
        for (a.classList.remove("observablehq--running"), a.classList.add("observablehq--error"); a.lastChild; )
...
function nt(e = "https://cdn.jsdelivr.net/npm/", t = ["unpkg", "jsdelivr", "browser", "main"]) {
    ...
    return async function (r, a) {
        ...
        if (!o.version && null != a && a.startsWith(e)) {
            ...
            o.version =
                (t.dependencies && t.dependencies[o.name]) || (t.peerDependencies && t.peerDependencies[o.name]);
        }
        if ((o.path && !et.test(o.path) && (o.path += ".js"), o.path && o.version && Qe.test(o.version)))
...
function ot(e) {
    ...
    for (const n of e)
        for (const e in n)
            Ke.call(n, e) && (null == n[e] ? Object.defineProperty(t, e, { get: it(n, e) }) : (t[e] = n[e]));
    return t;
}
function it(e, t) {
    return () => e[t];
            ...
            Je.call(t, st)
                ? (e) => {
                      const r = {},
                          a = { exports: r };
                      return Promise.all(
                          Ze.call(t, (t) => ("exports" === (t += "") ? r : "module" === t ? a : e(t)))
...
class SQLiteDatabaseClient {
    ...
    async describeTables({ schema: e } = {}) {
        return this.query(
            `SELECT NULLIF(schema, 'main') AS schema, name FROM pragma_table_list() WHERE type = 'table'${null == e ? "" : " AND schema = ?"} AND name NOT LIKE 'sqlite_%' ORDER BY schema, name`,
            null == e ? [] : [e]
        );
    }
    async describeColumns({ schema: e, table: t } = {}) {
        ...
        return n.map(({ name: e, type: t, notnull: n }) => ({ name: e, type: pt(t), databaseType: t, nullable: !n }));
    }
    async describe(e) {
...
class DuckDBClient {
    ...
    static async of(e = {}, t = {}) {
        ...
        return (
            ...
            void 0 === t.query?.castBigIntToDouble && (t = { ...t, query: { ...t.query, castBigIntToDouble: !0 } }),
            await n.open(t),
            await Promise.all(
    ...
    try {
        switch (n.mimeType) {
            ...
            case "text/tab-separated-values":
                return await o.insertCSVFromPath(n.name, { name: t, schema: "main", ...r }).catch(async (e) => {
            ...
            case "application/json":
                return await o.insertJSONFromPath(n.name, { name: t, schema: "main", ...r });
            default:
                if (/\.arrow$/i.test(n.name)) {
                    const e = new Uint8Array(await n.arrayBuffer());
                    return await o.insertArrowFromIPCStream(e, { name: t, schema: "main", ...r });
                }
                if (/\.parquet$/i.test(n.name))
                    return await o.query(`CREATE VIEW '${t}' AS SELECT * FROM parquet_scan('${n.name}')`);
...
async function xt(e, t, n, r) {
    ...
    try {
        await a.insertArrowTable(n, { name: t, schema: "main", ...r });
    } finally {
        await a.close();
    }
}
...
const It = Object.assign(
    async (e, t, n, r) => {
        if (
            ...
            (a = e) &&
                ("function" == typeof a.sql ||
                    ("function" == typeof a.queryTag &&
                        ("function" == typeof a.query || "function" == typeof a.queryStream))) &&
                ("table" !== o || "function" == typeof a.describeColumns) &&
                a !== It)
        )
            return Ft(
                e,
                (function (e, t) {
                    const n = "function" == typeof t.escape ? t.escape : (e) => e,
                        { select: r, from: a, filter: o, sort: i, slice: s } = e;
        ...
        if (jt(e))
            return (function (e, t) {
                ...
                if (t.derive) {
                    ...
                    t.derive.map(({ name: a, value: o }) => {
                        ...
                        fn(e, t).map((e, t) => {
                            ...
                            r[t] ? (r[t] = { ...r[t], [a]: n }) : r.push({ [a]: n });
                        }),
                            i.length && n.set(a, i);
                    });
                    const a = un(r, t);
                    (e = e.map((e, t) => ({ ...e, ...a.source[t] }))), (o = [...o, ...a.schema]);
                }
                for (const { type: n, operands: r } of t.filter) {
                    const [{ value: t }] = r,
                        a = r.slice(1).map(({ value: e }) => e);
                    switch (n) {
                        case "v": {
                            const [n] = a,
                                r = sn(n);
                ...
                for (const { column: n, direction: a } of (function (e) {
...
const Rt = Pt(async (e, t) => {
        ...
        return _t(e) || yt(e) ? Dt(e, t) : jt(e) && Ot(e) ? Array.from(e, (e) => ({ value: e })) : e;
    }),
    Ut = Pt(async (e, t) => {
        if (e instanceof FileAttachment) {
            switch (e.mimeType) {
...
function Ht({ type: e, operands: t }, n, r) {
    ...
    if (2 !== t.length || ["in", "nin"].includes(e)) {
        ...
        if (["c", "nc"].includes(e)) {
            ...
            return void Vt(((a = t[1]), { ...a, value: `%${a.value}%` }), n, r);
        }
        switch ((Vt(t[0], n, r), e)) {
            case "eq":
                zt(" = ", n);
...
function un(e, t) {
    const n = e;
    let { schema: r, inferred: a } = (function (e) {
        const { columns: t } = e;
        let { schema: n } = e;
        return $t(n) ? { schema: n, inferred: !1 } : ((n = mn(e, St(t) ? t : void 0)), { schema: n, inferred: !0 });
    })(e);
    const o = new Map(r.map(({ name: e, type: t }) => [e, t]));
    if (t.types) {
        for (const { name: e, type: a } of t.types) {
...
function mn(
    ...
    for (const e of t) {
        ...
        n.push({ name: e, type: o, inferred: o });
    }
    return n;
}
class Workbook {
    ...
    sheet(e, t) {
        ...
        return (function (e, { range: t, headers: n } = {}) {
            let [[r, a], [o, i]] = (function (e = ":", { columnCount: t, rowCount: n }) {
            ...
            for (let t = a; t <= i; t++) {
                const n = (l[t - a] = Object.create(null, { "#": { value: t + 1 } })),
                    i = e.getRow(t + 1);
                if (i.hasValues)
                    for (let e = r; e <= o; e++) {
...
async function _n(e, t, { array: n = !1, typed: r = !1 } = {}) {
...
class gn {
    ...
    async image(e) {
        ...
        return new Promise((n, r) => {
            const a = new Image();
            new URL(t, document.baseURI).origin !== new URL(location).origin && (a.crossOrigin = "anonymous"),
                Object.assign(a, e),
                (a.onload = () => n(a)),
                (a.onerror = () => r(new Error(`Unable to load file: ${this.name}`))),
                (a.src = t);
        });
    }
    ...
    element: function (e, t) {
        ...
        if (t)
            for (var i in t)
                (a = (r = i).indexOf(":")),
                    (n = t[i]),
                    a >= 0 && "xmlns" !== (r = i.slice(0, a)) && (i = i.slice(a + 1)),
                    Cn.hasOwnProperty(r) ? o.setAttributeNS(Cn[r], i, n) : o.setAttribute(i, n);
        return o;
    },
    input: function (e) {
...
function kn(e, t) {
    return function (n) {
        ...
        if (((p = e(f)), ++m > 0)) {
            for (o = new Array(m), i = document.createTreeWalker(p, NodeFilter.SHOW_COMMENT, null, !1); i.nextNode(); )
                (a = i.currentNode), /^o:/.test(a.nodeValue) && (o[+a.nodeValue.slice(2)] = a);
        ...
        function (e) {
            ...
            Object.defineProperties(
                ...
                ((n = {
                    ...
                    Inputs: () => t(xe.resolve()).then((e) => ({ ...e, file: e.fileOf(gn) })),
                    L: () =>
                        (async function (e) {
                        ...
                        (async function (e) {
                            ...
                            return (
                                ...
                                function () {
                                    ...
                                    return (
                                        (e.innerHTML = t.render(xn().id, String.raw.apply(String, arguments))),
...
function Variable(e, t, n, r) {
    ...
    n || (n = Kn),
        Object.defineProperties(this, {
            ...
            _definition: { value: tr, writable: !0 },
...
function ar(e, t, n) {
    ...
    if (
        (this._inputs.forEach(er, this),
        t.forEach(Qn, this),
        (this._inputs = t),
        (this._definition = n),
        (this._value = void 0),
        n === Jn ? a._variables.delete(this) : a._variables.add(this),
        ...
        if (this._name)
            if (this._outputs.size)
                r.delete(this._name),
                    ...
                    o._outputs.forEach(a._updates.add, a._updates),
                ...
                o._duplicates.delete(this),
                    ...
                    1 === o._duplicates.size &&
                        ((o = o._duplicates.keys().next().value),
                        (t = r.get(this._name)),
                        (o._outputs = t._outputs),
                        (t._outputs = new Set()),
                        o._outputs.forEach(function (e) {
...
function Module(e, t = []) {
    Object.defineProperties(this, {
        ...
        _builtins: { value: new Map([["@variable", or], ["invalidation", ir], ["visibility", sr], ...t]) },
...
function br(e, t) {
    ...
    return (
        a &&
            ((r = new IntersectionObserver(([e]) => (o = e.isIntersecting) && ((n = null), i()))),
            r.observe(a),
...
function wr(e) {
    ...
    const a = (e._promise = (
        e._inputs.length
            ? Promise.all(e._inputs.map(mr)).then(function (a) {
        ...
        if (
            ...
            return (
                ...
                (function (e, t, n) {
                    ...
                    let a;
                    function o(e) {
                        return new Promise((e) => e(n.next(a))).then(({ done: t, value: n }) =>
        ...
        value: async function () {
            ...
            do {
                for (
                    ...
                    wr(t), t._outputs.forEach(a), e.delete(t);
                e.forEach(function (t) {
